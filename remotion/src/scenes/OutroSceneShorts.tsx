    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          fontSize: 200, fontFamily: FONTS.display, fontWeight: 900,
          color: BRAND.yellow,
          textShadow: `
...
// ═══ SAHNE 2 ═══ Subscribe (DİKEY)
const Scene2Shorts: React.FC<{ startFrame: number }> = ({ startFrame }) => {
  const frame = useCurrentFrame();
  const { fps } = useVideoConfig();
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        padding: "48px 110px", borderRadius: 80,
      ...
      <div style={{
        ...
        padding: "26px 50px", borderRadius: 50,
        fontSize: 64, fontFamily: FONTS.display, fontWeight: 900,
        color: BRAND.white,
        textShadow: `
